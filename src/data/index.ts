...
export const Members = [
  {
    ...
    description: `My name is Aaron Marsh, and I am an aspiring Computer Scientist. I am currently a Full-Stack Developer who builds mobile and web applications. In addition, I work with Robotics and Machine Learning. As a member of the MEZ (Michigan Engineering Zone) our team has the awesome task of building competition ready robots! I am one who loses track of time solving problems and engineering new ways to do things. I have had the honor of working on things ranging from the internal tools used at DTE Energy to making robots drive themselves based on sensor input. Science is something that will always get me out of bed in the morning and something that will keep me awake at night. \n \n"We Do These Things Not Because They Are Easy But Because They Are Hard" ~ JFK`,
    projects: [
      {
    ...
    projects: [
      {
        title: "FIRST",
        description:
          " FIRST, a community where highschool students team up and build a robot for certain challenges every year. I am the CAD and Mechanical of my high school robotics team. I was apart of our accomplisment of winning 2019 Detroit FRC champion, and 2019 DPS ALL DPS robotics team award. We have been to 2019-2020 Deep Space State champion ships and 2019-2020 Deep Space World Championships Detroit. ",
        image: FRCLogo,
      },
      {
        title: "Math Corps",
        description:
          "A comminuty where everyone is accepted. A place where middle schoolers are taught math by high school students. Math corps isn't only about teaching math, but it is how we all can be one as a family and how we can share kindness throughout everyone in the world, even to the ones that struggledd the most in their own lives. I taught at math corps for 3 summers and 3 winters as a Teacher Assistance by teaching kids and Assisting my College Assistants in our team.   ",
        image: MathCorpsLogo,
      },
      {
        title: "DoDSTEM",
        description:
          "Science, Technology, Engineering and Mathematics, or STEM, is the gateway to a world of wonder. U.S. Department of Defense (DoD) STEM professionals work at the leading edge of our nation’s most advanced technological breakthroughs. I participated as a intern over there to work along side professional engineers where they taught me certain skils that I would use in real life during my career. They invite all students where they can learn about STEM and be apart of the community to help advance the world and the people in it.  ",
        image: DODStemLogo,
      },
      {
        title: "MIHSSCA ",
        description:
          "Michigan High School Soccer Coaches Association. A league I contributed a lot to the team since the team was very new because of COVID-19 and other things associated to the team not being able to start. I helped guide newer members to the team to get used to the game and to enjoy it.    ",
        image: MIHLogo,
      },
    ],
  },
    ...
    projects: [
      {
        title: "Discover Engineering with SHPE",
        description:
          "I took a course on how to use CAD Solidworks that was taught by Current U of M students where I was taught what troubleshooting was like and collaboration. I was then able to present my final design to a showcase at the end of the program.",
        image: SHPELogo,
      },
      {
        title: "Connect Me Online Tutoring",
